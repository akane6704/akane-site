...
fn app() -> Html {
    html! {
        <>
            ...
            <p>{"I hate OOP languages, and love low-medium level and statically-typed programming languages(my favorite programming language is Rust btw, also this site was made in Rust)."}</p>
            <p>{"I know C, C++, Python and Rust(looking for learning Javascript), I use Arch btw(switching to gentoo), and use Neovim for literally every programming language."}</p>
